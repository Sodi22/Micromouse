...
def generate_launch_description():
    ...
    gazebo_models_path, ignore_last_dir = os.path.split(pkg_ros2_micromouse)
    ...
    urdf_file_path = PathJoinSubstitution([
        pkg_ros2_micromouse,  # Replace with your package name
        "urdf",
    ...
    world_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(pkg_ros2_micromouse, 'launch', 'world.launch.py'),
        ),
        launch_arguments={
    ...
    rviz_node = Node(
        package='rviz2',
        executable='rviz2',
        arguments=['-d', os.path.join(pkg_ros2_micromouse, 'rviz', 'rviz.rviz')],
    ...
    spawn_urdf_node = Node(
        ...
        arguments=[
            ...
            "-x", "-3.15", "-y", "3.15", "-z", "0.25", "-Y", "0.0"  # Initial spawn position
        ],
        output="screen",
        parameters=[
            {'use_sim_time': True},
