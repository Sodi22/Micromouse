...
def generate_launch_description():
    ...
    pkg_ros2_micromouse = FindPackageShare('ros2_micromouse')
    default_rviz_config_path = PathJoinSubstitution([pkg_ros2_micromouse, 'rviz', 'urdf.rviz'])
